module github.com/dominikus1993/distributed-tracing-sample/shopping-list-storage
...
require (
	...
	github.com/uptrace/opentelemetry-go-extra/otellogrus v0.1.11 // indirect
	...
	go.opentelemetry.io/contrib/instrumentation/go.mongodb.org/mongo-driver/mongo/otelmongo v0.31.0 // indirect
