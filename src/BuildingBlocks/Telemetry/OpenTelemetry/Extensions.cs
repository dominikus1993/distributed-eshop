...
{
    public SampleOpenTelemetryBuilder(OpenTelemetryBuilder openTelemetryBuilder, IHostEnvironment environment, Service service)
    {
...
public static class OpenTelemetryExtensions
{
    ...
    public static SampleOpenTelemetryBuilder AddOpenTelemetryTracing(this SampleOpenTelemetryBuilder builder, Action<TracerProviderBuilder>? setup = null)
    {
    ...
    public static SampleOpenTelemetryBuilder AddOpenTelemetryMetrics(this SampleOpenTelemetryBuilder builder, Action<MeterProviderBuilder>? setup = null)
    {
